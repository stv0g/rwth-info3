/* 
 * SimuClient f�r MacOS/Linux (Praktikum Informatik 2, WS 2009/10 RWTH Aachen)
 * Version 0.5
 * von Robert Uhl, 2009 - 2010
 * Vielen Dank an den Lehrstuhl EECS, RWTH Aachen, f�r den Zugang zum Quellcode
 * des SimuClient f�r Windows.
 * Datei: SimuClient.h
...
void Sleep(const int mSec);				// ersetzt die Sleep()-Funktion von Windows, die mSek �bernimmt
void vBeendeGrafik(void);

// Zus�tzliche Schnittstellen wegen eventueller Konvertierungsprobleme bei string/char*
